...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/FFGSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "**Designation:** FFG" "index designation"
require_contains "$PARTS_DIR/_index.md" "BDS Documentation Protocol v2.0" "index protocol"
require_contains "$PARTS_DIR/_index.md" 'Primary output: `doc/FFGSYSTEM.md`' "index primary output"
require_contains "$PARTS_DIR/BUILD.sh" 'DESIGNATION="FFG"' "build designation"
...
require_contains "$ASSEMBLED_OUTPUT" "**Designation:** FFG" "assembled designation"
require_contains "$ASSEMBLED_OUTPUT" 'Primary output: `doc/FFGSYSTEM.md`' "assembled primary output"
